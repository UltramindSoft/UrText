...
tic
[detector, info] = trainFasterRCNNObjectDetector(Ysr_trainingData2b,lgraph , options, ...
...
YsrModel_Name=['Yasser_FasterRCNN_Chandio2020_Urdu_resnet50_Trained_On_' num2str(size(Ysr_trainingData,1)) '_Tested_On_' num2str(size(Ysr_testData,1)) '-images_n_Model-Name_' Used_Model '_Ep' num2str(YasserEpochs) '_' num2str(Y_TrainTime) '_.mat'];
...
%         % Run the detector.
        [bboxes, scores, labels] = detect(detector, I,'ExecutionEnvironment','gpu','MiniBatchSize',1,'NumStrongestRegions',30);
% 
%         %%
%         %%/////////////////////////////////////////////////////////////////
...
YsrModel_Name=['Yasser_FasterRCNN_Chandio2020_Urdu_resnet50_Trained_On_' num2str(size(Ysr_trainingData,1)) '_Tested_On_' num2str(size(Ysr_testData,1)) '-images_n_Model-Name_' Used_Model '_Ep' num2str(YasserEpochs) '_Tr_ap-' num2str(train_ap_Train) '_Ts_ap-' num2str(test_ap_Test) '_TrainTime-' num2str(Y_TrainTime) '-Seconds_.mat'];
